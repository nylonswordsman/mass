...
4. Go to your Documents directory in File Explorer.
      * Make sure you're in the `Documents` folder and not OneDrive!
      * `Game.exe` should be located in a folder called `mass`. Run Game.exe to run the demo.
...
1. Add `Game.exe` as a non-Steam game on Steam.
      * The botton for this should be in the bottom left of the Library screen, below the list of games on the left side.
3. Right-click Game.exe in your library. `Properties -> Compatability -> Force usage of specific compatability tool`
4. Go down the list of tools and try running the game until one of them lets it launch.
...
2. `cd` to the location of the repo.
    * If you were following the guide, the command should be `cd ~/Documents/mass`.
