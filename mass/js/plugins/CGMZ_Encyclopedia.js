 ...
 * games.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version adds the option to show enemy traits using the
 * same traits display as for other entries. To set this up, add the traits
 * and/or traits header display options to the bestiary window.
 *
 * This update also fixes a bug with actor names not updating in the list
 * window when the actor name changes during gameplay.
 * 
 * Version 1.13.1
...
CGMZ.Versions["Encyclopedia and Bestiary"] = "1.13.1";
CGMZ.Encyclopedia = {};
